...
void PersWiFiManager::setupWiFiHandlers()
{
  ...
  _aserver->on("/restart", HTTP_GET, [](AsyncWebServerRequest *request) {
  ...
  _aserver->on("/reset", HTTP_GET, [](AsyncWebServerRequest *request) {
  ...
  _aserver->onNotFound([&](AsyncWebServerRequest *request) {
    ...
    request->redirect("/index.htm"); // send all DNS requests to wifi
  });
